    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(help_text='Изображение рецепта', upload_to='', verbose_name='Изображение')),
                ('text', models.CharField(help_text='Описание рецепта', max_length=1000, verbose_name='Описание')),
                ('cooking_time', models.PositiveSmallIntegerField(help_text='Время приготовления рецепта', verbose_name='Время приготовления')),
